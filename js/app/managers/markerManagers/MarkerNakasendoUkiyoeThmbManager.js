(function(global) {
    ...
    MyApp.MarkerNakasendoUkiyoeThmbManager = class MarkerNakasendoUkiyoeThmbManager {
        ...
        _createCoreManager(targetTimeRangeType, targetUrl) {
            var layerName = 'route_nakasendo_ukiyoe_thmb';
            var callbacks = {
                'tooltipContentCallback': MarkerNakasendoUkiyoeThmbManager._buildTooltipContent,
                'popupContentCallback': null,
                'filterGeojsonPredicate': MarkerNakasendoUkiyoeThmbManager._filterGeojsonPredicate,
            };
            var options = {
