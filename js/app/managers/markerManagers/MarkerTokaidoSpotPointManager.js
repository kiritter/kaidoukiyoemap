(function(global) {
    ...
    MyApp.MarkerTokaidoSpotPointManager = class MarkerTokaidoSpotPointManager {
        ...
        _createCoreManager(targetTimeRangeType, targetUrl) {
            ...
            var callbacks = {
                'tooltipContentCallback': MarkerTokaidoSpotPointManager._buildTooltipContent,
                'popupContentCallback': null,
                'filterGeojsonPredicate': MarkerTokaidoSpotPointManager._filterGeojsonPredicate,
            };
            var options = {
                ...
                shouldTooltip: true,
                tooltipNames: {className: 'tooltip-spot-point-tokaido', geZoom: 'spotPointTooltipGeZoom', direction: 'spotPointTooltipDirection'},
                shouldPopup: false,
            };
