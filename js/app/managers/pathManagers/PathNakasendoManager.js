(function(global) {
    ...
    MyApp.PathNakasendoManager = class PathNakasendoManager {
        ...
        _createCoreManager(targetTimeRangeType, targetUrl) {
            ...
            var coreManager = new MyApp.LineCoreManager(this.mapBoth, this.globalState, layerName, targetTimeRangeType, targetUrl);
            return coreManager;
        }
