(function(global) {
    ...
    MyApp.InitialSetViewManager = class InitialSetViewManager {
        constructor(gaChannel, mapBoth, globalState, urlQueryParamRepo, clickManager) {
        ...
        createWith(urlQueryParamRepo) {
            var created = new InitialSetViewManager(this.gaChannel, this.mapBoth, this.globalState, urlQueryParamRepo, this.clickManager);
            return created;
        }
