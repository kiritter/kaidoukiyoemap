async function initMyApp(global) {
    ...
    var urlCopyManager = new MyApp.UrlCopyManager(gaChannel, mapBoth, MyApp.globalState, urlRepo, clickManager, global.navigator);
    urlCopyManager.init();

    var initialSetViewManager = new MyApp.InitialSetViewManager(gaChannel, mapBoth, MyApp.globalState, urlQueryParamRepo, clickManager);
